...
{
    class MyCustomListAdapter : BaseAdapter<Section>
    {
        List<Section> sections;
               

        public MyCustomListAdapter(List<Section> sections)
        {
    ...
    internal class MyCustomListAdapter1ViewHolder : Java.Lang.Object
    {
